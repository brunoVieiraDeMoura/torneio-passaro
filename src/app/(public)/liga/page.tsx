...
import { ALL_LIGA as MOCK } from '@/data/liga-data'

const PODIUM_COLOR = ['#B45309', '#6B7280', '#92400E']
const PODIUM_LABEL = ['Ouro', 'Prata', 'Bronze']
const PODIUM_BG    = ['#FFFBEB', '#F9FAFB', '#FFF7ED']

const ESTADOS = [...new Set(MOCK.map(e => e.estado))].sort()
const TIPOS   = [...new Set(MOCK.map(e => e.tipo_ave))].sort()
const ESTILOS = [...new Set(MOCK.map(e => e.estilo_canto))].sort()
...
export default function LigaPage() {
  ...
  }, [scope, estado, cidade, tipoAve, estilo, limit, userOverride])
